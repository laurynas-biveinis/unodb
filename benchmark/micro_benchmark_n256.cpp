...
BENCHMARK_TEMPLATE(grow_n48_to_n256_sequentially, unodb::olc_db)
    ->Range(2, 2048)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(grow_n48_to_n256_sequentially, unodb::art_map_db)
    ->Range(2, 2048)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(grow_n48_to_n256_randomly, unodb::olc_db)
    ->Range(2, 2048)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(grow_n48_to_n256_randomly, unodb::art_map_db)
    ->Range(2, 2048)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(n256_sequential_add, unodb::olc_db)
    ->Range(1, 1024)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(n256_sequential_add, unodb::art_map_db)
    ->Range(1, 1024)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(n256_random_add, unodb::olc_db)
    ->Range(1, 1024)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(n256_random_add, unodb::art_map_db)
    ->Range(1, 1024)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(minimal_n256_tree_full_scan, unodb::olc_db)
    ->Range(4, 4096)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(minimal_n256_tree_full_scan, unodb::art_map_db)
    ->Range(4, 4096)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(minimal_n256_tree_random_gets, unodb::olc_db)
    ->Range(4, 4096)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(minimal_n256_tree_random_gets, unodb::art_map_db)
    ->Range(4, 4096)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(full_n256_tree_full_scan, unodb::olc_db)
    ->Range(128, 131064)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(full_n256_tree_full_scan, unodb::art_map_db)
    ->Range(128, 131064)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(full_n256_tree_random_gets, unodb::olc_db)
    ->Range(128, 131064)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(full_n256_tree_random_gets, unodb::art_map_db)
    ->Range(128, 131064)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(full_n256_tree_sequential_delete, unodb::olc_db)
    ->Range(192, 196608)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(full_n256_tree_sequential_delete, unodb::art_map_db)
    ->Range(192, 196608)
    ->Unit(benchmark::kMicrosecond);
...
BENCHMARK_TEMPLATE(full_n256_tree_random_delete, unodb::olc_db)
    ->Range(192, 196608)
    ->Unit(benchmark::kMicrosecond);
BENCHMARK_TEMPLATE(full_n256_tree_random_delete, unodb::art_map_db)
    ->Range(192, 196608)
    ->Unit(benchmark::kMicrosecond);
