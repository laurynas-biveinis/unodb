...
using key_view_db = unodb::db<key_view, unodb::value_view>;
using key_view_mutex_db = unodb::mutex_db<key_view, unodb::value_view>;
using key_view_olc_db = unodb::olc_db<key_view, unodb::value_view>;
